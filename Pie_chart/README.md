# 🧬 Variant Classification — Pie Chart Visualization Toolkit (R)

A lightweight R toolkit to generate **publication-ready pie charts** describing variant distributions in genetic studies.
...
|--------|--------|---------|
| **1** | Variant Classification Pie Chart | Missense / Frameshift / Splice / Stop Gained breakdown |
| **2** | REVEL Score Pie Chart | VUS / LP / P / LB distribution |
| **3** | LoF Variant Classification Pie Chart | VUS / P / LB breakdown of loss-of-function variants |

---

## ⚙️ Requirements

Before running the scripts, install required libraries (only for Section 2 and 3):
